...
public class InternalAuthoritiesRestController extends WorkshopRestControllerAbstract<InternalAuthority> {
	 ...
	 */
	public InternalAuthoritiesRestController(InternalAuthoritiesService internalAuthoritiesService,
