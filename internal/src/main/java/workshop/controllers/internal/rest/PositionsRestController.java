...
public class PositionsRestController extends WorkshopRestControllerAbstract<Position> {
	 ...
	 *                         to operate with.
	 */
	public PositionsRestController(PositionsService positionsService, PositionsResourceAssembler positionsResourceAssembler) {
	 ...
	 * {@link InternalAuthoritiesRestController#postOne(WorkshopEntity, BindingResult, WebRequest)}
