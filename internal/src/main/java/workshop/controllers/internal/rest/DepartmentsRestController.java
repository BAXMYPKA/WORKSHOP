...
public class DepartmentsRestController extends WorkshopRestControllerAbstract<Department> {
	...
	/**
	 * @see WorkshopRestControllerAbstract#WorkshopRestControllerAbstract(WorkshopEntitiesServiceAbstract, WorkshopEntitiesResourceAssemblerAbstract) )
	 */
	public DepartmentsRestController(DepartmentsService departmentsService, DepartmentsResourceAssembler departmentsResourceAssembler) {
