...
public class WorkshopEntityTypesRestController extends WorkshopRestControllerAbstract<WorkshopEntityType> {
	 ...
	 */
	public WorkshopEntityTypesRestController(
	...
	public ResponseEntity<String> postEntityTypeAuthorityPermission(
		...
		@Validated(Persist.class) @RequestBody AuthorityPermission authorityPermission,
	...
	public ResponseEntity<String> putEntityTypeAuthorityPermission(
		@PathVariable(name = "id") Long id,
		@Validated(Merge.class) @RequestBody AuthorityPermission authorityPermission,
		BindingResult bindingResult) {
