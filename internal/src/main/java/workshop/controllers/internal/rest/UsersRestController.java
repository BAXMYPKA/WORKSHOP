...
public class UsersRestController extends WorkshopRestControllerAbstract<User> {
	 ...
	 *                     to operate with.
	 */
	public UsersRestController(UsersService usersService, UsersResourceAssembler usersResourceAssembler) {
	...
	/**
	 * @return HttpStatus.FORBIDDEN with an advice to use dedicated {@link ExternalAuthoritiesRestController#postOne(WorkshopEntity, BindingResult, WebRequest)}
	 * link for creation.
	 */
