...
public class TasksRestController extends WorkshopRestControllerAbstract<Task> {
	 ...
	 */
	public TasksRestController(TasksService tasksService, TasksResourceAssembler tasksResourceAssembler) {
