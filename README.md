 ...
 * Само приложение, занимающее в памяти около /////////////тут расчитать!
 ...
 После выключения ///////////////КАК ВЫКЛЮЧАТЬ приложение гасит базу данных и все изменения сгорают. Вам на память остаются только кука с языком кука JWT-токеном - обе с небольшим сроком жизни.
