...
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1092, CURRENT_DATE, CURRENT_TIMESTAMP(), 'testuserTwo@meail.pro', 'UserTwoFirst', 'UserTwoLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1093, CURRENT_DATE, CURRENT_TIMESTAMP(), 'userThree@mailto.ru', 'UserThreeFirst', 'UserThreeLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1094, CURRENT_DATE, CURRENT_TIMESTAMP(), 'testuserFour@mail.eu', 'UserFourFirst', 'UserFourLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1095, CURRENT_DATE, CURRENT_TIMESTAMP(), 'testuserFive@mailing.org', 'UserFiveFirst', 'UserFiveLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1096, CURRENT_DATE, CURRENT_TIMESTAMP(), 'testuserSix@mail.prod', 'UserSixFirst', 'UserSixLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1097, CURRENT_DATE, CURRENT_TIMESTAMP(), 'testuserSeven@email.lv', 'UserSevenFirst', 'UserSevenLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1098, CURRENT_DATE, CURRENT_TIMESTAMP(), 'testuserEight@email.alb', 'UserEightFirst', 'UserEightLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
INSERT INTO EXTERNAL.USERS (ID, BIRTHDAY, CREATED, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD)
VALUES (1099, CURRENT_DATE, CURRENT_TIMESTAMP(), 'testuserNine@pro.mail', 'UserNineFirst', 'UserNineLast',
		'$2a$10$xT0XO4QAEwkdBQpExuYOXOq0uzSkxBvFiwPKXapsziUoGFQW0B4xS');
;
;
