...
* Желательно свободный HTTP-порт 18080. *Его можно изменить в файле "workshop.properties" в строке "httpPort="*
 ...
 * И на непосредственно сам Department, которому эта Position принадлежит (relation="PositionDepartment").
...
*Приложение пока не слишком функционально, т.к. должно управляться через интерфейс, который показывает все возможности,
