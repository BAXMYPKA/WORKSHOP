...
public class OrdersRestController extends WorkshopRestControllerAbstract<Order> {
	...
	public OrdersRestController(OrdersService ordersService, OrdersResourceAssembler ordersResourceAssembler) {
