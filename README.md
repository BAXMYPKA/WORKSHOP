...
Для добавления интерактивности на страницах есть несколько скриптовых велосипедов для поиска, валидации и изменения стиля.
...
В данном демо-режиме все работает без HTTPS и передается открыто.
...
* Фронтэнд для внутреннего сервиса должен быть отдельным React приложением, активно взаимодействующим с Java REST-сервисом бекэнда - он пока в планах. Его временно заменяют стандартные тестовые HTML MVC странички.
